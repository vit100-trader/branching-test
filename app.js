...
function startApp() {
  ...
  console.log('Modules loaded: login, dashboard, profile, notifications');
}

startApp();

module.exports = { startApp, loginUser, logoutUser, renderDashboard, refreshDashboard, getProfile, updateProfile, getNotifications, markAsRead };
